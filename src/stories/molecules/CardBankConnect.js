	...
	template: `
		<div class="d-flex align-items-stretch">
			<div class="rounded-lg border border-light bg-brand-secondary-4 p-3 w-100">
				...
				<bank-details :bank="bank" name-class="font-weight-bold text-brand-copy-1 line-height-3"></bank-details>
				<div class="font-brand text-brand-copy-1 mt-1">
					<div class="py-2">Connection status</div>
					<div class="line-height-normal" :class="{ 'mb-1': $scopedSlots.default }">
